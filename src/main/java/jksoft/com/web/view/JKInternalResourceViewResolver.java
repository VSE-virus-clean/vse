 ...
 * </pre>
 *
 * @ClassName   : JKInternalResourceViewResolver.java
 * @Description : 접속 Device별 JSP파일의 prefix를 설정하기 위해InternalResourceViewResolver를 상속받음.
 ...
 * </pre>
 */
public class JKInternalResourceViewResolver extends InternalResourceViewResolver {
    
    /**
     * LoggerFactory
     */
    private final Logger log = LoggerFactory.getLogger(JKInternalResourceViewResolver.class);
