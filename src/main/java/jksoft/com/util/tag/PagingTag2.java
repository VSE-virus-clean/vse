...
public class PagingTag2 extends SimpleTagSupport
{
    ...
    public void doTag() throws JspException, IOException
    {
        ...
        if(totalRow > 0){
            ...
            //첫페이지로
            if(page > 1){
                btFirst = "<li class=\"prev\"><a href=\"" + url + 1 + "\">&lt;&lt;</a></li>";
            }
            
            //이전 페이지
            if(page > pageLimit){
                btPrev = "<li class=\"prev\"><a href=\"" + url + (startPage - 1) + "\">&lt;</a></li>";
            }
           
            //다음 페이지
            if((startPage + pageLimit) <= totalPage){
                btNext = "<li class=\"next\"><a href=\"" + url + (startPage + pageLimit) + "\">&gt;</a></li>";
            }  
            
            //마지막 페이지로
            if(page < totalPage){
                btLast = "<li class=\"next\"><a href=\"" + url + totalPage + "\">&gt;&gt;</a></li>";
            }
        ...
        //출력
        out.println("<ul class=\"page\">" + btFirst + btPrev + btPage + btNext + btLast + "</ul>");    
    }
}
