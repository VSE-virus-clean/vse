...
public class MemberVO extends SearchVO {
    ...
    private String scssRson = "";
    private String scssMbrId = "";
    private String tmpPwYn = "N";
	...
	public String getScssRson() {
		return scssRson;
	}
	public void setScssRson(String scssRson) {
		this.scssRson = scssRson;
	}
	public String getScssMbrId() {
		return scssMbrId;
	}
	public void setScssMbrId(String scssMbrId) {
		this.scssMbrId = scssMbrId;
	}
