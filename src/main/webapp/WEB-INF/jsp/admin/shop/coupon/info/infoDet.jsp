	...
	<div class="r_search_box">
	    <form name="mainForm" method="post" action="${contextPath}/${requestUri}/delete.vc" onsubmit="var rtn = formSubmitObj.submit(this); if(!rtn){ submitUtil.enable(); } return rtn;">
	        ...
	        <table class="r_search_table">
	            ...
	            <tr>
	            	<th>공지여부</th>
	                <td>${'Y' eq result.info.notiYn ? '공지' :'비공지'}</td>     
	            	<th>공개여부</th>
	                <td>${'Y' eq result.info.useYn ? '공개' :'비공개'}</td>     
	            </tr>
	            <tr>
	                <th>작성자</th>
	            ...
	            <tr>    
	                <th>첨부파일</th>
	                <td colspan="3" class="con">
	                	<p>${function:printAttachFileList("ATTCH", result.file.list)}</p>
	                </td>   
	            </tr>
	        </table>
	        <div class="btn_area mgbtm30">
	            ...
	            <div class="btn_right">
	                <a href="${contextPath}/${requestUri}/modify.vc?blcSn=${result.info.blcSn}${function:searchQuery(result.searchInfo)}" class="btnstyle blue">수정</a>
