...
--%>
<div class="sec_top">
	<h3 class="sec_tit">VSE 사업설명회 정보</h3>
	<ul class="top_tab">
	...
	<div class="r_search_box">
	    <form name="mainForm" method="post" action="${contextPath}/${requestUri}/delete.vc" onsubmit="var rtn = formSubmitObj.submit(this); if(!rtn){ submitUtil.enable(); } return rtn;">
	        ...
	        <table class="r_search_table">
	            ...
	            <tr>    
	                <th>주소</th>
	                <td colspan="3" class="con">${result.info.blcSbc1}</td>   
	            </tr>
	            <tr>    
	                <th>연락처</th>
	                <td colspan="3" class="con">${result.info.blcSbc2}</td>     
	            </tr>
	            <tr>    
	                <th>운영시간</th>
	                <td colspan="3" class="con">${result.info.blcSbc3}</td>    
	            </tr>
	            <tr>    
	                <th>시설</th>
	                <td colspan="3" class="con">${result.info.blcSbc4}</td>     
	            </tr>
	            <tr>    
	                <th>이미지</th>
