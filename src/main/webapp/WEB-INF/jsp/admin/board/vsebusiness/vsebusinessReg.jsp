...
--%>
<div class="sec_top">
	<h3 class="sec_tit">VSE 사업설명회 등록</h3>
	<ul class="top_tab">
	    ...
	    <form name="mainForm" method="post" enctype="multipart/form-data" onsubmit="var rtn = formSubmitObj.submit(this); if(!rtn){ submitUtil.enable(); } return rtn;">
	        <table class="r_search_table">
	            ...
	            <tr>    
	                ...
	                <td>
	                    <input type="text" id="blcSbc1" name="blcSbc1" maxlength="100" style="width:95%;" title="주소" />
	                </td>   
	            </tr>
	             <tr>    
	                <th class="necessary">연락처</th>
	                <td>
	                    <input type="text" id="blcSbc2" name="blcSbc2" maxlength="100" style="width:95%;" title="연락처" />
	                </td>   
	            </tr>
	             <tr>    
	                <th class="necessary">운영시간</th>
	                <td>
	                    <input type="text" id="blcSbc3" name="blcSbc3" maxlength="100" style="width:95%;" title="운영시간" />
	                </td>   
	            </tr>
	             <tr>    
	                <th class="necessary">시설</th>
	                <td>
	                    <input type="text" id="blcSbc4" name="blcSbc4" maxlength="100" style="width:95%;" title="시설" />
	                </td>   
	            </tr>
	            <tr>    
	                ...
	                <td>
	                	<div class="filebox">
	                   		${function:printAttachFileReg(1, "THUMB", "이미지")}
	                    </div>
	                    <ul class="warn">
