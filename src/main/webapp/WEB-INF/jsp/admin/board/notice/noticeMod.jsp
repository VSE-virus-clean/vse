	            ...
	            <tr>    
	                ...
	                <td colspan="3" class="con">
	                	<div class="filebox">
		                    ...
		                    ${function:printAttachFileModList2("Y", 1, "ATTCH", "첨부파일", result.file.list, "Y")}
	                    </div>
	                </td>   
	            </tr>
	        </table>
...
$(function () {
    $('form[name=mainForm]').ready(function(){
        ...
        $('input[name=notiYn][value=${result.info.notiYn}]').prop('checked', true).trigger('click');  
        $('input[name=secretYn][value=${result.info.secretYn}]').prop('checked', true); 
