...
var loginObj = {
    ...
    moveLogin : function(returnUrl){
        location.replace( loginObj.pagePath + (loginObj.isDevice != 'N' ? '/m' : '') + '/member/login.vc?returnUrl='+ encodeURIComponent((returnUrl == undefined || returnUrl == '' ? location.href : returnUrl)));
    }    
};
