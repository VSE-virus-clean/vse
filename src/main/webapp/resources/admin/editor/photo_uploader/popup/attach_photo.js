	 ...
	 */
     function goStartMode(){
    	 ...
    	 if(sSrc.indexOf("btn_confirm2.png") < 0 ){
    		 welBtnConfirm.attr("src","/resources/admin/editor/img/photoQuickPopup/btn_confirm2.png");
     ...
     function goReadyMode(){
    	 ...
    	 if(sSrc.indexOf("btn_confirm2.png") >= 0 ){
	    	 ...
	    	 welBtnConfirm.attr("src","/resources/admin/editor/img/photoQuickPopup/btn_confirm.png");
    	 }
     }   
    ...
    function addImage(ofile){
		...
		if( !!bExceedLimitTotalSize ){
	        ...
	        aFileList.push('	<a onclick="delImage(\'img'+nImageInfoCnt+'\')"><img class="del_button" src="/resources/admin/editor/img/photoQuickPopup/btn_del.png"  width="14" height="13" alt="첨부 사진 삭제"></a>');
			aFileList.push('	</li> ');   
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			...
 			sUrl  : '/admin/cm/pop/ccMan.vc',  //샘플 URL입니다.
 	        sCallback : '/admin/cm/pop/ccCallBackMan.vc',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소, 서버단에서 호출되는 것이기 때무에 ContextPath를 빼줘야 한다.ㄴ
...
// 	    		oCustomEvent.stop(); 수행시 bAllowed 가 false이더라도 alert이 수행되지 않음
 	    	...
 	    	error : function(oCustomEvent) {
 	    		...
 	    		// 	}
 	    		//}
 	    		var wel = jindo.$Element("error");
 	    		var errorMessage = '';
 	    		
 	    		switch(oCustomEvent.htResult.errstr){
 	    		    case 'msg.A53' : errorMessage = "첨부가 불가능한 파일을 업로드 하셨습니다."; break;
 	    		    case 'msg.A52' : errorMessage = "업로드 파일 허용 용량을 초과했습니다.\n10MB 이하의 파일을 업로드 해 주십시오."; break;
 	    		    default : errorMessage = "작업중 에러가 발생했습니다."; break;
 	    		}
 	    		wel.html(errorMessage);
 	    		//alert(errorMessage);
 	    	}
 	    });
 	}
